...
class Nave(ElementoJogo):
    def __init__(self, largura_tela, altura_tela, velocidade=15, cor=(0, 255, 100)):
        ...
        sprite = pygame.image.load("Image/Spaceship.png").convert_alpha()
    ...
    def processar_evento(self, evento):
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if (
                evento.key in (pygame.K_LEFT, pygame.K_a)
                and self.vel_x < 0
                or evento.key in (pygame.K_RIGHT, pygame.K_d)
                and self.vel_x > 0
            ):
                self.vel_x = 0

        elif evento.type == pygame.KEYDOWN and evento.key in pygame.K_SPACE:
            self.atirar()
    ...
    def atirar(self):
        ...
        projetil = Tiro(self.rect.x, self.rect.y, self.largura_tela, self.altura_tela)
